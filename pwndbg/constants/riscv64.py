...
__NR_riscv_hwprobe = Constant("__NR_riscv_flush_icache", 258)
...
__NR_statmount = Constant("__NR_statmount", 457)
__NR_listmount = Constant("__NR_listmount", 458)
__NR_lsm_get_self_attr = Constant("__NR_lsm_get_self_attr", 459)
__NR_lsm_set_self_attr = Constant("__NR_lsm_set_self_attr", 460)
__NR_lsm_list_modules = Constant("__NR_lsm_list_modules", 461)
